...
export const validationSchema = Joi.object({
  ...
  /** OpenAI (import menú desde foto + traducción automática). Opcional. */
  OPENAI_API_KEY: Joi.string().optional().allow(''),
  OPENAI_MODEL: Joi.string().optional().allow('').default('gpt-4o'),
  /** Modelo dedicado a traducción automática; si vacío, usa OPENAI_MODEL o gpt-4o-mini. */
  OPENAI_TRANSLATE_MODEL: Joi.string().optional().allow(''),
