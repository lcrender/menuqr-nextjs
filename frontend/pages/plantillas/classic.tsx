...
export default function PlantillaClasicaPage() {
  const catalog = getTemplateBySlug('classic');
      ...
      <div className="landing-page">
        ...
        <main className={styles.wrap}>
          <div className="container">
            <PlantillaLandingArticle content={L} catalog={catalog} idPrefix="classic" variant="default" />
          </div>
        </main>
        <LandingFooter />
      </div>
