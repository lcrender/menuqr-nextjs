...
export default function PrivacyBodyEs({ preciosHref }: PrivacyBodyProps) {
  return (
    <>
      <p>
        Esta Política de Privacidad describe cómo <strong>App Menu QR</strong> recopila, utiliza y protege la
        información de los usuarios que utilizan la plataforma disponible en <strong>appmenuqr.com</strong> (en adelante,
        “la Plataforma”).
      </p>
      <p>Al utilizar la Plataforma, el usuario acepta las prácticas descritas en esta política.</p>
      ...
      <p>
        Formulario de contacto: <Link href="/contacto?from=privacidad">Abrir formulario</Link>
      </p>

      <h2 style={{ fontSize: '1.1rem', marginTop: '24px' }}>2. Información que Recopilamos</h2>
      <p>
        La Plataforma puede recopilar información proporcionada por los usuarios al registrarse o utilizar el servicio.
      ...
      <p style={{ marginTop: '16px' }}>
        La cantidad de restaurantes, menús y productos que puede gestionar cada cuenta depende del plan contratado. Los
        límites y precios vigentes se publican en la <Link href={preciosHref}>página de precios</Link> de la Plataforma.
      </p>
      ...
      <p>
        Estos proveedores pueden procesar información necesaria para brindar sus servicios de acuerdo con sus propias
      ...
      <p>
        Los usuarios pueden solicitar la eliminación de su cuenta y de sus datos personales en cualquier momento.
      </p>

      <h2 style={{ fontSize: '1.1rem', marginTop: '24px' }}>6. Derechos del Usuario</h2>
      <p>
        De acuerdo con la Ley 25.326 de Protección de Datos Personales de la República Argentina, los usuarios tienen
        derecho a:
      </p>
      <ul>
      ...
      <p>
        La Plataforma adopta medidas técnicas y organizativas razonables para proteger la información de los usuarios
        contra accesos no autorizados, pérdida o alteración.
      </p>
      <p>
        Sin embargo, ningún sistema de transmisión o almacenamiento de datos en Internet puede garantizar seguridad
        absoluta.
      </p>

      <h2 style={{ fontSize: '1.1rem', marginTop: '24px' }}>8. Cambios en esta Política</h2>
      <p>
        El titular de la Plataforma podrá modificar esta Política de Privacidad en cualquier momento. Los cambios serán
