...
export const FUNCIONES_SECTIONS: FuncionesSection[] = [
  ...
  },
  {
    ...
    title: {
      AR: 'Añade alérgenos a tu menú digital',
      ES: 'Añade alérgenos a tu carta digital',
    },
    ctaLabel: {
      AR: 'Declarar alérgenos en el menú',
      ES: 'Declarar alérgenos en la carta',
    },
    metaTitle: {
      AR: 'Alérgenos en el menú digital | App Menu QR',
      ES: 'Alérgenos en la carta digital | App Menu QR',
    },
    metaDescription: {
      AR: 'Informá alérgenos e iconos dietéticos en tus productos para que el comensal los vea en el menú QR.',
      ES: 'Informa alérgenos e iconos dietéticos en tus productos para que el comensal los vea en la carta QR.',
    },
    lead: {
      AR: 'Marcá alérgenos y preferencias (sin gluten, vegano, vegetariano, etc.) en cada producto. La información se muestra en la carta pública para ayudar a tus clientes a elegir con confianza.',
      ES: 'Marca alérgenos y preferencias (sin gluten, vegano, vegetariano, etc.) en cada producto. La información se muestra en la carta pública para ayudar a tus clientes a elegir con confianza.',
    },
    bullets: {
      AR: [
        ...
        'Mantené la carta alineada a la normativa de tu local.',
      ],
      ES: [
        'Iconos y etiquetas visibles en la carta digital.',
        'Edición por producto desde el panel.',
        'Útil para filtros y lectura rápida en el móvil.',
        'Mantén la carta alineada a la normativa de tu local.',
      ],
    },
  },
  {
    ...
    title: {
      AR: 'Traduce tu menú digital y muéstralo en varios idiomas',
      ES: 'Traduce tu carta digital y muéstrala en varios idiomas',
    },
    ctaLabel: {
      AR: 'Traducir mi menú',
      ES: 'Traducir mi carta',
    },
    metaTitle: {
      AR: 'Menú digital multidioma | App Menu QR',
      ES: 'Carta digital multidioma | App Menu QR',
    },
    metaDescription: {
      AR: 'Traducí tu menú QR a varios idiomas: banderas en la carta, editor por idioma y traducción automática en planes Pro.',
      ES: 'Traduce tu carta QR a varios idiomas: banderas en la carta, editor por idioma y traducción automática en planes Pro.',
    },
    lead: {
      AR: 'Llegá a turistas y clientes internacionales con menús multilingües. Agregá idiomas, editá textos por idioma y mostrá u ocultá cada versión en la carta pública.',
      ES: 'Llega a turistas y clientes internacionales con cartas multilingües. Añade idiomas, edita textos por idioma y muestra u oculta cada versión en la carta pública.',
    },
    bullets: {
      AR: [
        'Idiomas por menú con banderas en la carta QR.',
        'Editor para revisar y corregir cada traducción.',
        'Visibilidad pública por idioma.',
        'Traducción automática (beta) en planes Pro, Pro Team y Premium.',
      ],
      ES: [
        'Idiomas por carta con banderas en la carta QR.',
        'Editor para revisar y corregir cada traducción.',
        'Visibilidad pública por idioma.',
        'Traducción automática (beta) en planes Pro, Pro Team y Premium.',
      ],
